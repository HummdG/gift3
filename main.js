...
let scene1 = gsap.timeline();
        ScrollTrigger.create({
            ...
            scrub: 3,
            onEnter: () => gsap.to("#goodMorningText", { opacity: 1 }),
            onLeave: () => gsap.to("#goodMorningText", { opacity: 0 }),
        });
...
let scene3 = gsap.timeline();
        ScrollTrigger.create({
            ...
            scrub: 3,
            onEnter: () => {
                gsap.to("#goodMorningText", { opacity: 0 });
                gsap.to("#goodNightText", { opacity: 1, display: 'block' });
            },
            onLeaveBack: () => {
                gsap.to("#goodMorningText", { opacity: 1 });
                gsap.to("#goodNightText", { opacity: 0, display: 'none' });
            }
        });
